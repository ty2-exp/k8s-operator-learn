...
//+kubebuilder:rbac:groups=opendata.example.com,resources=stocks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=opendata.example.com,resources=stocks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=opendata.example.com,resources=stocks/finalizers,verbs=update
